...
export const _ROWS = [
  {
    label: 'Projets',
    total: 10,
    content: 'Gestion de projets, développement de logiciels, conception de produits.',
  },
  {
    label: 'Applications',
    total: 5,
    content: 'Développement d\'applications mobiles, développement web, solutions logicielles sur mesure.',
  },
  {
...
export const _faqs = [
  {
    id: '1',
    question: 'Quels sont les avantages de faire concevoir une application sur mesure pour mon entreprise ?',
    answer: 'Une application sur mesure peut répondre parfaitement aux besoins spécifiques de votre entreprise, améliorant ainsi l\'efficacité opérationnelle, la productivité et offrant une expérience utilisateur optimale.'
  },
  {
    id: '2',
  ...
  {
    id: '4',
    question: 'Comment assurez-vous la sécurité des données dans les applications que vous concevez ?',
    answer: 'La sécurité des données est notre priorité. Nous mettons en œuvre des pratiques de développement sécurisé, des protocoles de cryptage robustes et des tests rigoureux pour garantir que vos données restent sécurisées à tout moment.'
  },
  {
    id: '5',
